...
func TestRelay_BasicRelayAndUsage(t *testing.T) {
	...
	require.JSONEq(t, `{"id":"resp_123","usage":{"input_tokens":7,"output_tokens":3,"input_tokens_details":{"cached_tokens":2}}}`, string(result.TerminalResponseBody))
...
func TestRelay_OnTurnComplete_PerTerminalEvent(t *testing.T) {
	...
	require.JSONEq(t, `{"id":"resp_turn_1","usage":{"input_tokens":2,"output_tokens":1}}`, string(turns[0].TerminalResponseBody))
	...
	require.JSONEq(t, `{"id":"resp_turn_2","usage":{"input_tokens":3,"output_tokens":4}}`, string(turns[1].TerminalResponseBody))
