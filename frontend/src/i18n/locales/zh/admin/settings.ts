...
// Settings
    settings: {
      ...
      usageRanking: {
        title: '用量排行',
        description: '控制用户侧用量排行榜的入口、排序方式与公开字段。',
        enabled: '启用用量排行',
        enabledHint: '关闭后用户无法从导航或接口访问排行榜。',
        sortBy: '排名依据',
        sortByHint: '按所选指标的正值入榜，排名依据会始终展示。',
        limit: '显示数量',
        limitHint: '每个时间范围显示前 1-100 名用户。',
        fields: '显示字段',
        fieldsHint: '关闭字段会同时从用户接口响应中省略。',
        totalTokens: '总 Token',
        requests: '请求数',
        actualCost: '实际消费',
        sortOptions: {
      ...
      scheduling: {
        ...
        stickyEscapeTitle: '粘性健康切换',
        stickyEscapeDescription: '绑定账号的错误率或首 token 延迟超过阈值时，本次请求允许切换到其它账号，并保留原粘性绑定。',
        stickyEscapeEnabled: '启用强制粘性切换',
        stickyEscapeTTFT: 'TTFT 切换阈值（毫秒）',
        stickyEscapeErrorRate: '错误率切换阈值（0-1）',
        ewmaTitle: 'EWMA 反馈因子',
        ewmaDescription: '控制运行时错误率和首 token 延迟反馈对最新样本的敏感度；值越大越重视最新观测。',
      ...
      payment: {
        ...
        connectionTestSuccess: '易支付连接测试成功',
