...
// Redeem Codes
    redeem: {
      ...
      editCode: 'Edit',
      editCodeTitle: 'Edit Redeem Code',
      codeUpdated: 'Redeem code updated successfully',
      valueLockedHint:
        'This code has redemption records, so value and subscription plan are locked to keep history consistent.',
      maxUsesBelowUsed: 'Redemption limit cannot be less than current usage count',
