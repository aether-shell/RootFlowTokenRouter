...
// Groups
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit OpenAI reasoning effort requests only. Omitted effort stays omitted. The ceiling takes precedence over reasoning effort mappings.',
