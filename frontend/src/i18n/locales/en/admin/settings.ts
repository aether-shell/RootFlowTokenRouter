...
// Settings
    settings: {
      ...
      scheduling: {
        ...
        stickyEscapeTitle: 'Sticky health escape',
        stickyEscapeDescription: 'When a bound account exceeds the error-rate or TTFT threshold, this request may switch accounts while preserving the original sticky binding.',
        stickyEscapeEnabled: 'Enable forced sticky switching',
        stickyEscapeTTFT: 'TTFT switch threshold (ms)',
        stickyEscapeErrorRate: 'Error-rate switch threshold (0-1)',
        ewmaTitle: 'EWMA feedback factors',
        ewmaDescription: 'Control how strongly runtime error-rate and TTFT feedback respond to the latest sample; higher values react faster.',
      ...
      payment: {
        ...
        connectionTestSuccess: 'EasyPay connection test succeeded',
